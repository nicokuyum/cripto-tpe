...
public class TestMain {
	...
	public static void main(String[] args) {
		...
		byte[] cipheredText = encryptionAlgorithm.encrypt(message.getBytes(), EncryptionMode.ECB, pass.getBytes());
		System.out.println("Ciphered: " + new String(cipheredText));
		byte[] decryptedText = encryptionAlgorithm.decrypt(cipheredText, EncryptionMode.ECB, pass.getBytes());
